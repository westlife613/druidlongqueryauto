...
public class DruidLongQueryExample {
    ...
    public static void initDataSource() {
        ...
        try {
            ...
            log("⚠️ Warning: connectTimeout=90ms, socketTimeout=90ms may cause query timeout");
        } catch (SQLException e) {
    ...
    public static void executeLongQuery(String sql) {
        ...
        try {
            ...
            log("Total records processed: " + count);
            log("Total time: " + (endTime - startTime) / 1000.0 + " seconds");
